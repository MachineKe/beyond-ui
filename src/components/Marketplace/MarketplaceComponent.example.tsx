...
const MarketplaceSection = () => {
  const myProducts: Product[] = [
    ...
    },
    {
      ...
      id: "p7",
      name: "Custom Camera",
      description: "A high-end camera for professionals.",
      price: 499.99,
      ...
      inStock: true,
      specifications: { CPU: "Snapdragon 865", RAM: "8GB", Storage: "256GB" },
      tags: ["camera", "electronics", "premium"],
      vendor: { id: "v7", name: "MyVendor", rating: 4.1, logo: "https://images.pexels.com/photos/2255935/pexels-photo-2255935.jpeg" }
    },
    {
      id: "p8",
      name: "Custom Monitor",
